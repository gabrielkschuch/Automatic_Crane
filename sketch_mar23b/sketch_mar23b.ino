...
void Reset_motor() {
  digitalWrite(IN1_MOTOR_ROLDANA, 0);
  digitalWrite(IN2_MOTOR_ROLDANA, 0);
  digitalWrite(IN3_MOTOR_ROLDANA, 0);
  digitalWrite(IN4_MOTOR_ROLDANA, 0);

  digitalWrite(IN1_MOTOR_GARRA, 0);
  digitalWrite(IN2_MOTOR_GARRA, 0);
  digitalWrite(IN3_MOTOR_GARRA, 0);
  digitalWrite(IN4_MOTOR_GARRA, 0);
}
void loop()
{
  /*
  ...
  */
  while (choice != "get up" and choice != "get down")
  {
    ...
    {
      Serial.println("I did not comprehend what you typed");
      Serial.println("Please type 'get up' or 'get down'");
  ...
  */
  ...
  if (choice != "" and choice != "get up" and choice != "get down") {
    choice = "reset";
  }
  /*
